...
public enum BaseErrorCode {
    ...
    INVALID_TIME("00071", "无效时间"),
    PLATE_NUMBER_ERROR("00072", "车牌号错误"),
    CAMERA_NUMBER_ERROR("00073", "摄像头编号错误"),
    CALLBACK_URL_ERROR("00074", "回调地址URL错误"),
    TIME_FORMAT_LIMIT_ERROR("00075", "时间格式必须是ISO-8601"),
    PAGE_NUMBER_LIMIT_ERROR("00076", "页码超出限制"),
    PAGE_SIZE_LIMIT_ERROR("00077", "分页大小超出限制"),
    THIRD_PARTY_INTERFACE_FAILED("00078", "调用第三方接口失败"),
    JSON_PARSING_ERROR("00079", "json解析错误"),
    JSON_FIELD_TYPE_ERROR("00080", "json消息字段类型错误"),
    JSON_FIELD_VALUE_ERROR("00081", "json消息字段取值错误"),
    JSON_FIELD_TYPE_MISSING("00082", "json消息字段缺失"),
    JSON_OBJECT_CREATE_FAILED("00083", "创建json对象失败"),
    JSON_ARRAY_CREATE_FAILED("00084", "创建json数组失败"),
    JSON_FORMAT_ERROR("00085", "json格式或内容错误"),
    FILE_NAME_ERROR("00086", "文件名错误"),
    FILE_ADDRESS_NOT_EXIST("00087", "文件地址不存在"),
    FILE_ID_NOT_EXIST("00088", "文件ID不存在"),
    FILE_ID_TOO_LONG("00089", "文件ID超长"),
    FILE_TYPE_ERROR("00090", "文件类型错误"),
    FILE_CREATE_ERROR("00091", "创建文件失败"),
    FILE_OPEN_ERROR("00092", "打开文件失败"),
    DOWNLOAD_ERROR("00093", "下载文件失败"),
    FILE_READ_ERROR("00094", "读取文件失败"),
    FILE_WRITE_ERROR("00095", "写入文件失败"),
    FILE_FORMAT_ERROR("00096", "文件格式错误"),
    FILE_IS_ENCRYPTED("00097", "文件被加密"),
    FILE_TRANSFER_ERROR("00098", "文件转换失败"),
    EXCEL_BUILD_FAILED("00099", "Excel生成失败"),
    EXCEL_IMPORT_FAILED("00100", "Excel导入失败"),
    ENCODING_CONVERSION_FAILED("00101", "文本编码转换失败"),
    FILE_UNRECOGNIZED("00102", "未识别文件"),
    FILE_SIZE_ERROR("00103", "文件大小超过限制"),
    FILE_UPLOAD_ERROR("00104", "文件上传失败"),
    FILE_IS_BEING_UPLOADED("00105", "其它用户正在上传该文件"),
    USER_NOT_EXIST("00106", "用户不存在"),
    USER_NOT_LOGGED_IN("00107", "用户未登录"),
    PERMISSION_DENY_ERROR("00108", "用户没有权限"),
    PASSWORD_ERROR("00109", "密码错误"),
    USERNAME_ALREADY_EXISTS("00110", "用户名已存在"),
    USERNAME_LENGTH_ERROR("00111", "用户名长度错误"),
    PASSWORD_LENGTH_ERROR("00112", "密码长度错误"),
    USERNAME_OR_PASSWORD_FORMAT_ERROR("00113", "用户名或密码格式错误"),
    USERNAME_OR_PASSWORD_EMPTY("00114", "用户名或密码为空"),
    LOGIN_EXPIRED("00115", "用户登录已过期"),
    SECURITY_AUTHENTICATION_FAILED("00116", "安全认证失败"),
    ACCOUNT_LOCKED("00117", "账号被锁定"),
    USER_ADD_ERROR("00118", "添加用户失败"),
    USER_DELETE_ERROR("00119", "删除用户失败"),
    USER_UPDATE_ERROR("00120", "修改用户失败"),
    USER_QUERY_ERROR("00121", "查询用户失败"),
    PASSWORD_UPDATE_ERROR("00122", "修改密码失败"),
    NEW_PASSWORD_ERROR("00123", "新密码错误"),
    NEW_PASSWORD_LENGTH_ERROR("00124", "新密码长度错误"),
    OLD_PASSWORD_LENGTH_ERROR("00125", "原密码长度错误"),
    OLD_PASSWORD_ERROR("00126", "原密码错误"),
    PASSWORD_SAME_ERROR("00127", "新密码与原密码相同"),
    USERNAME_OR_PASSWORD_ERROR("00128", "用户名或密码错误"),
    DEVICE_ACQUISITION_FAILED("00129", "设备获取失败"),
    CHANNEL_ACQUISITION_FAILED("00130", "通道获取失败"),
    DEVICE_OFFLINE("00131", "设备离线"),
    RESOURCE_TREE_ACQUISITION_FAILED("00132", "资源树获取失败"),
    RESOURCE_EXIST_ERROR("00133", "资源已经存在"),
    DEVICE_NOT_EXIST("00134", "设备不存在"),
    DEVICE_ALREADY_EXISTS("00135", "设备已经存在"),
    DEVICE_LIMIT_ERROR("00136", "设备数达到上限"),
    CHANNEL_LIMIT_ERROR("00137", "通道数达到上限"),
    CAMERA_ID_ERROR("00138", "相机ID错误"),
    CAMERA_NAME_ERROR("00139", "相机名错误"),
    IPC_CODE_TOO_LONG("00140", "IPC设备编码超长"),
    IPC_NAME_TOO_LONG("00141", "IPC设备名称超长"),
    IPC_STYLE_ACQUISITION_FAILED("00142", "获取IPC款型失败"),
    ...
    PARAM_SWITCH_ERROR("01006", "参数转换异常"),
    ;
